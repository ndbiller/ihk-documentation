...
Die benötigten Mittel zur Durchführung des Projektes werden vom Auftraggeber Doctena zur Verfügung gestellt. Eine detaillierte Auflistung der zur Durchführung benötigten Ressourcen findet sich im~\Anhang{app:Ressourcen}. Die Benutzung dieser Ressourcen wird mit pauschalen Werten für die in Kapitel 3 angestellten Berechnungen berücksichtigt.
